// LangSmith sink ¡ª parses SSE, extracts cache metrics, sends clean traces.
...
let enabled = !!API_KEY;
if (!enabled) console.warn("[tee/langsmith] LANGSMITH_API_KEY not set ¡ª disabled");
  ...
  const payload = {
    ...
    extra: {
      metadata: {
        ...
        status: resStatus,
        // Cache ¡ª filterable in LangSmith UI
